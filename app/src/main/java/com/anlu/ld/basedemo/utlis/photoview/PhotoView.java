package com.anlu.ld.basedemo.utlis.photoview;
    ...
    public void animaFrom(Info info) {
        if (isInit) {
            ...
            if (info.mWidgetRect.width() < info.mImgRect.width() || info.mWidgetRect.height() < info.mImgRect.height()) {
                ...
                PhotoView.ClipCalculate c = info.mScaleType == ScaleType.FIT_START ? new PhotoView.START() : info.mScaleType == ScaleType.FIT_END ? new PhotoView.END() : new PhotoView.OTHER();
    ...
    public void animaTo(Info info, Runnable completeCallBack) {
        if (isInit) {
            ...
            if (info.mWidgetRect.width() < info.mRect.width() || info.mWidgetRect.height() < info.mRect.height()) {
                ...
                final PhotoView.ClipCalculate c = info.mScaleType == ScaleType.FIT_START ? new PhotoView.START() : info.mScaleType == ScaleType.FIT_END ? new PhotoView.END() : new PhotoView.OTHER();
